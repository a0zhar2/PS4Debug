...
uint64_t DBREG_DR7_MASK(int i) {
    return ((uint64_t)(0xf) << ((i) * 4 + 16) | 0x3 << (i) * 2);
}
...
uint64_t DBREG_DR7_SET(int i, uint64_t len, uint64_t access, uint64_t enable) {
    return ((uint64_t)((len) << 2 | (access)) << ((i) * 4 + 16) | (enable) << (i) * 2);
}
...
uint64_t DBREG_DRX(uint64_t* d, int x) { return d[x]; }

// Function to handle attaching to a process for debugging
...
// Function to handle breakpoint's
...
// Function to handle watch-point's
...
// Function to handle getting information about threads
...
// Function to handle stopping a thread
...
// Function to handle resuming a thread
...
// Function to handle getting register information
...
// Function to handle setting register information
...
// TO-DO: add comment to this function
...
// Function to handle getting debug register information
...
// Function to handle setting debug register information
...
// Function to handle stopping or resuming execution
...
// Function to handle getting information about a thread
...
// Function to handle single-stepping through execution
...
// Function to handle incoming debugging commands
